...
impl<T> Pack<T> {
    ...
    /// Puts elements in the other Pack at the end of this one.
    /// After this, all handles referring to the other Pack are considered invalid.
    pub fn extend(&mut self, other: Pack<T>) {
